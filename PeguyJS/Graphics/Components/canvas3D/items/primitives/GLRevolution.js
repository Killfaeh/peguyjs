...
function GLRevolution($verticesList, $angle, $smoothTheta, $resolution, $closeStart, $closeEnd, $textureMode, $axis)
{
	///////////////
	// Attributs //
	///////////////
	...
	var init = function()
	{
		var revolutionData = GLData.createRevolutionData(verticesList, angle, smoothTheta, resolution, closeStart, closeEnd, axis);
...
if (Loader !== null && Loader !== undefined)
	Loader.hasLoaded("gl-revolution");